                ...
                motherboardRef.get()
                        .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                ...
                                Double motherboardPriceLong = (Double) documentSnapshot.get("price");
                                String motherboardPriceString = Double.toString(motherboardPriceLong);
                                Log.d(TAG, "CPU Cooler Price: " + motherboardPriceString);
